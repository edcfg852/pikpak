...
```
npm create cloudflare@latest -- --template=cloudflare/templates/pikpak
```

A live public deployment of this template is available at [https://pikpak.templates.workers.dev](https://pikpak.templates.workers.dev)
